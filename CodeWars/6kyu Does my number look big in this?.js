...
// in a given base. In this Kata, we will restrict ourselves 
// to decimal (base 10).
...
function narcissistic(value) {
  ...
  // reduce() runs a callback function on each of the elements in the array,
  // and return the sum of all the elements in an array.